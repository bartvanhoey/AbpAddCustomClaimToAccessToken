...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 4aaf53e8-546e-4aed-939f-e29a732da17a
```

> `4aaf53e8-546e-4aed-939f-e29a732da17a` is the password of the certificate, you can change it to any password you want.
